	...
	public static void main(String[] args) {
        ...
        */
		...
		do {
			...
			System.out.println("4.-Buscar un auto por nombre");
			System.out.println("5.-Eliminar auto por nombre");
			...
			case 5:
			    System.out.println("Eliminar auto por marca:");
			    scan.nextLine();
			    System.out.print("Ingresa la marca del auto a eliminar: ");
			    String marcaEliminar = scan.nextLine();
			    boolean eliminado = false;

			    for (int i = 0; i < carros.size(); i++) {
			        if (carros.get(i).getMarca().equalsIgnoreCase(marcaEliminar)) {
			            carros.remove(i);
			    ...
			    if (!eliminado) {
			        System.out.println("No se encontró un auto con esa marca.");
			    }
			    break;
			...
			case 7:
			    carros.clear();
			    System.out.println("Todos los autos han sido eliminados.");
			    break;
